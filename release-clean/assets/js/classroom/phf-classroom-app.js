...
(function(){
  ...
  function hydrateClassroomData(root){hydrateAdminDashboard(root);hydrateClassList(root);hydrateClassDetail(root);hydrateLearnerClasses(root);hydrateClassroomUsers(root);hydrateSchedule(root);hydrateAttendance(root);hydrateLearning(root);hydrateMaterials(root);hydrateResults(root);hydrateProposals(root);hydrateSettings(root);phfcEnhanceDateTimeInputs(root);}
