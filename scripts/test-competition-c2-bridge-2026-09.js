...
(async () => {
  ...
  ok(COMPETITION_ACTION_MANIFEST.length === 39, 'manifest has all 39 C1 actions mapped (' + COMPETITION_ACTION_MANIFEST.length + ')');
  ok(new Set(COMPETITION_ACTION_MANIFEST).size === 39, 'manifest has no duplicate action names');
