...
(async () => {
  ...
  // not a plain ACTION_MAP passthrough, see competition-actions.js).
  ok(COMPETITION_ACTION_MANIFEST.length === 40, 'manifest has all 39 C1 actions + 1 C4.3 composite action mapped (' + COMPETITION_ACTION_MANIFEST.length + ')');
  ok(new Set(COMPETITION_ACTION_MANIFEST).size === 40, 'manifest has no duplicate action names');
