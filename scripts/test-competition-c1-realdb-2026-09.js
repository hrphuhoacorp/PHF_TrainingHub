...
(async () => {
  ...
  // was a hardcoded ===15; now >=15 — V1.3 (submission_occurrences) and the
  // 2026-09-05 Notification V1 migration (competition.notifications) added
  // tables to this schema since this gate was written. A minimum bound still
  // proves the foundation migration applied; it no longer breaks on every
  // additive migration.
  ...
  ok(typeof prodSelf.processed === 'number' && prodSelf.assigned >= prodSelf.processed, 'reviewer sees own productivity', prodSelf);
