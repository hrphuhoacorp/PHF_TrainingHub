...
const PERSONAS = [
  { name: 'P1 admin / company-wide (received+managed)', relation: 'received', scope: 'managed', eventLimit: 150,
    scopeObj: scopeOf({ employeeCode: '', actorType: 'admin', accountId: 'acct-e2e-admin', managedEmployeeCodes: new Set() }, 'all_company', [], true) },
  { name: 'P2 ordinary employee PHF082 (received / self)', relation: 'received', scope: undefined, eventLimit: 150,
    scopeObj: scopeOf({ employeeCode: 'PHF082', actorType: 'nhan_vien', accountId: null, managedEmployeeCodes: new Set() }, 'self', [], false) },
  { name: 'P3 manager PHF010 (received + managed subtree)', relation: 'received', scope: 'managed', eventLimit: 150,
    scopeObj: scopeOf({ employeeCode: 'PHF010', actorType: 'truong_bo_phan', accountId: null, managedEmployeeCodes: new Set(['PHF073', 'PHF005', 'PHF036']) }, 'employees', ['PHF073', 'PHF005', 'PHF036'], true) },
  { name: 'P4 creator PHF002 (assigned / Tôi giao)', relation: 'assigned', scope: undefined, eventLimit: 150,
    scopeObj: scopeOf({ employeeCode: 'PHF002', actorType: 'nhan_vien', accountId: null, managedEmployeeCodes: new Set() }, 'self', [], false) },
];
