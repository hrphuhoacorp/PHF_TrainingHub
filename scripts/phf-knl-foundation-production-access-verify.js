...
const {getKnlEmployeeIncome,incomeScopeAllows}=require('../lib/knl-foundation');
...
(async()=>{
  ...
  console.log('PASS Production income access: own PHF091, Admin PHF092, income_view fail-closed and employee incomeScope allow/deny.');
