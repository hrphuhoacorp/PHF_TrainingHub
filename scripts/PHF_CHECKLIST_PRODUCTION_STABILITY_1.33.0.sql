...
revoke all on function public.phf_transition_checklist_task(uuid,text,text,text,text,text,text,text,integer) from public,anon,authenticated;
...
grant execute on function public.phf_transition_checklist_task(uuid,text,text,text,text,text,text,text,integer) to service_role;
