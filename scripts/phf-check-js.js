...
const MANUAL_VERSIONED_ASSETS=['assets/js/knl/phf-knl-app.js','assets/css/phf-knl.css','assets/js/phf-account-admin-safe.js','assets/js/ai/phf-ai-engine.js','assets/css/phf-ai-sandbox.css'];
