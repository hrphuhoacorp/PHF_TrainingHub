...
const { getEmployeeIncomeForAi, getEmployeeCompetencyStatusForAi, listProvisionalCompetencyForAi } = require('../api/_lib/ai-knl-income-tools');
const { AI_TOOLS, ALLOWED_TOOL_NAMES, executeToolCall, buildStructuredResult } = require('../api/_lib/ai-tool-registry');
