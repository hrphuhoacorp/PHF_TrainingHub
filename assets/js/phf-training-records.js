...
(function(){
  ...
  function injectCss(){
    ...
    style.textContent=`
      ...
      @media(max-width:980px){.phf-eval-workspace.phf-records-detail-page{padding-left:16px;padding-right:16px}.phf-records-profile-card{padding:18px}.phf-probation-summary{grid-template-columns:1fr 1fr}.phf-records-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.phf-records-filter{grid-template-columns:1fr 1fr}.phf-records-info{grid-template-columns:1fr 1fr}}
      @media(max-width:620px){.phf-eval-workspace.phf-records-detail-page{padding-left:10px;padding-right:10px}.phf-records-detail-page .phf-eval-work-head{padding:18px}.phf-records-profile-card{padding:16px}.phf-records-grid,.phf-records-filter,.phf-records-info,.phf-records-bmtt-meta,.phf-probation-summary,.phf-probation-conditions,.phf-probation-editor .phf-records-filter{grid-template-columns:1fr}.phf-records-detail-head{display:block}.phf-records-actions{margin-top:10px}}
    `;
