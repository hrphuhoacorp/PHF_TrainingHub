...
(function(){
  ...
  function injectCss(){
    ...
    style.textContent=`
      .phf-eval-workspace.phf-records-detail-page{max-width:1240px;padding-left:22px;padding-right:22px;box-sizing:border-box;gap:18px}
      .phf-records-detail-page .phf-eval-work-head{padding:20px 24px}
      .phf-records-detail-page .phf-records-main-tabs{margin-bottom:0}
      .phf-records-profile-card{padding:20px 22px 16px;box-sizing:border-box}
      ...
      .phf-records-card{border:1px solid #dbe8e1;border-radius:15px;background:#fff;padding:17px 18px;min-width:0}.phf-records-card span{display:block;color:#6c7f76;font-size:12px;margin-bottom:7px}.phf-records-card b{display:block;color:#07543e;font-size:22px;overflow-wrap:anywhere}
      .phf-records-detail-head{display:flex;justify-content:space-between;gap:18px;align-items:flex-start}.phf-records-detail-head h3{margin:0 0 5px;color:#07543e;overflow-wrap:anywhere}.phf-records-detail-head p{margin:0;color:#667b71;line-height:1.5}
      .phf-records-info{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px;margin-top:16px}.phf-records-info>div{min-width:0;border:1px solid #e0ebe5;border-radius:12px;padding:13px 14px;background:#fbfdfc}.phf-records-info span{display:block;color:#6f8179;font-size:12px;margin-bottom:5px}.phf-records-info b{display:block;color:#17382d;line-height:1.4;overflow-wrap:anywhere}
      .phf-records-subtabs{display:flex;gap:9px;flex-wrap:wrap;margin:18px 0 0}.phf-records-subtabs button{border:1px solid #d4e3dc;background:#f7fbf9;color:#285245;border-radius:999px;padding:9px 14px;font-weight:700;cursor:pointer}.phf-records-subtabs button.active{background:#075b45;color:#fff;border-color:#075b45}
      ...
      .phf-probation-shell{overflow:hidden;padding:22px 24px 20px;box-sizing:border-box}.phf-probation-top{display:flex;justify-content:space-between;gap:20px;align-items:flex-start;padding:0 2px}.phf-probation-top>div{min-width:0}.phf-probation-top h3{margin:0 0 6px}.phf-probation-top p{margin:0;line-height:1.55;color:#61746b}.phf-probation-top>.phf-eval-chip{flex:0 0 auto;margin-top:1px}.phf-probation-summary{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px;margin-top:18px}.phf-probation-summary>div{min-width:0;border:1px solid #e0ebe5;border-radius:13px;padding:13px 14px;background:#fbfdfc}.phf-probation-summary span{display:block;color:#6f8179;font-size:12px;margin-bottom:7px}.phf-probation-summary b{display:block;color:#17382d;line-height:1.4;overflow-wrap:anywhere}.phf-probation-summary .phf-eval-chip{display:inline-flex;margin:0;max-width:100%}
      .phf-probation-section{margin-top:20px;padding-top:18px;border-top:1px solid #e4ede9}.phf-probation-section h4{margin:0 0 12px;color:#17382d;font-size:15px}.phf-probation-conditions{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:11px}.phf-probation-condition{display:flex;justify-content:space-between;gap:12px;align-items:center;min-width:0;border:1px solid #e0ebe5;border-radius:13px;padding:11px 12px;background:#fff}.phf-probation-condition span:first-child{color:#61746b;font-size:12px;line-height:1.35}.phf-probation-condition .phf-eval-chip{flex:0 0 auto}.phf-probation-shell>.phf-records-note{margin-left:0!important;margin-right:0!important}.phf-probation-actions{display:flex;justify-content:flex-end;gap:9px;flex-wrap:wrap;margin-top:16px;padding-top:2px}.phf-probation-editor{margin-top:16px;border:1px solid #dce9e3;border-radius:15px;padding:16px;background:#fafdfb}.phf-probation-editor[hidden]{display:none!important}.phf-probation-editor-head{display:flex;justify-content:space-between;gap:12px;align-items:center;margin-bottom:14px}.phf-probation-editor-head h4{margin:0;color:#17382d}.phf-probation-editor .phf-records-filter{grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.phf-probation-editor .phf-records-filter>div{min-width:0}
      ...
      @media(max-width:980px){.phf-eval-workspace.phf-records-detail-page{padding-left:16px;padding-right:16px}.phf-records-profile-card{padding:18px}.phf-probation-shell{padding:20px}.phf-probation-summary{grid-template-columns:1fr 1fr}.phf-records-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.phf-records-filter{grid-template-columns:1fr 1fr}.phf-records-info{grid-template-columns:1fr 1fr}}
      @media(max-width:620px){.phf-eval-workspace.phf-records-detail-page{padding-left:10px;padding-right:10px}.phf-records-detail-page .phf-eval-work-head{padding:18px}.phf-records-profile-card{padding:16px}.phf-probation-shell{padding:17px 15px}.phf-probation-top{gap:12px}.phf-probation-top>.phf-eval-chip{margin-top:0}.phf-records-grid,.phf-records-filter,.phf-records-info,.phf-records-bmtt-meta,.phf-probation-summary,.phf-probation-conditions,.phf-probation-editor .phf-records-filter{grid-template-columns:1fr}.phf-records-detail-head{display:block}.phf-records-actions{margin-top:10px}}
    `;
  ...
  async function render(view,employeeId,tab){
    ...
    if(view==='detail'){
      ...
      host.innerHTML=`<section class="phf-eval-workspace phf-eval-content-enter phf-records-detail-page">${renderDetail(emp,tab||'overview')}</section>`;
    }else if(view==='bmtt'){
