...
(function(){
  ...
  function accounts(){
    ...
    l=[
      {id:'acct-learner-',name:'Học viên ',email:'nv.@phf.local',phone:'0900000001',role:'learner',status:'active',note:'Tài khoản học viên . Login thật vẫn dùng luồng ổn định của web.',createdAt:now(),lastLogin:''},
