...
(function(){
  ...
  var ROUTE_REGISTRY=Object.freeze({
    ...
    '/ql/knl/dashboard':Object.freeze({area:'manager',screen:'knl-dashboard',roles:['manager']}),
    ...
    '/ql/checklist/ho-so-danh-gia':Object.freeze({area:'manager',screen:'checklist-assessment-profile',roles:['manager']}),
    ...
    '/admin/knl/dashboard':Object.freeze({area:'admin',screen:'knl-dashboard',roles:['admin']}),
  ...
  window.PHF_ROUTE_MAP=Object.freeze({
    public:['/','/login'],
    learner:['/hv','/hv/home','/hv/knl','/hv/knl/nhan-su','/hv/knl/khao-sat','/hv/knl/ket-qua-khao-sat','/hv/bai-hoc','/hv/ho-so','/hv/checklist','/hv/checklist/ho-so-danh-gia','/hv/classroom','/hv/classroom/lich','/hv/classroom/tai-lieu','/hv/classroom/bai-kiem-tra','/hv/classroom/ket-qua','/hv/classroom/de-xuat'],
  ...
  window.PHF_ROUTE_MAP.learner.push('/hv/task','/hv/task/tao','/hv/task/chi-tiet','/hv/task/nhan','/hv/task/giao','/hv/task/nhan-su-toi-quan-ly','/hv/task/de-xuat/toi-gui','/hv/task/de-xuat/toi-nhan-xu-ly','/hv/task/lich');
  window.PHF_ROUTE_MAP.management.push('/ql/task','/ql/task/tao','/ql/task/chi-tiet','/ql/task/nhan','/ql/task/giao','/ql/task/nhan-su-toi-quan-ly','/ql/task/de-xuat/toi-gui','/ql/task/de-xuat/toi-nhan-xu-ly','/ql/task/lich');
  window.PHF_ROUTE_MAP.admin.push('/admin/task','/admin/task/nhan-su','/admin/task/tao','/admin/task/chi-tiet','/admin/task/nhan','/admin/task/giao','/admin/task/nhan-su-toi-quan-ly','/admin/task/de-xuat/toi-gui','/admin/task/de-xuat/toi-nhan-xu-ly','/admin/task/lich');
  ...
  function canonicalLegacyPath(path){
    ...
    if(path==='/admin/tai-khoan'||path==='/admin/quan-tri/tai-khoan'||path==='/admin/accounts') return '/admin/nhan-su/tai-khoan';
  ...
  async function render(path,fromPop,meta){
    ...
    try{
      ...
      if(path==='/ql/knl'||path==='/ql/knl/nhan-su'||path==='/ql/knl/co-cau-thu-nhap'||path==='/ql/knl/phan-quyen'||path==='/ql/knl/khao-sat'||path==='/ql/knl/ket-qua-khao-sat'||path==='/ql/knl/de-xuat-nang-bac'||path==='/ql/knl/dashboard'){
        if(!requireRoles(['manager']))return false;
        await Promise.resolve(window.phfRenderKnl&&window.phfRenderKnl(path));
        return true;
      }
      ...
      if(path==='/admin/nhan-su/tai-khoan'){
        /* Account Admin là sub-screen của PHF HR (Quản trị nhân sự), không phải
           của khu Quản trị chung (Training Hub) /admin/quan-tri/*. Route này
           phải nằm dưới /admin/nhan-su để PHFAppShell.shellFor() (index.html)
           và main() trong phf-account-admin-safe.js cùng nhận diện đúng shell
           PHF HR — cả hai nơi hiện chỉ nhận diện theo tiền tố /admin/nhan-su. */
        if(!requireRoles(['admin']))return false;
        if(window.PHFAppShell)window.PHFAppShell.activateHr({clear:false,restoreTitle:false});
        if(typeof window.phfRenderAccountAdminSafe!=='function')throw new Error('PHF_ACCOUNT_ADMIN_RENDERER_MISSING');
        await Promise.resolve(window.phfRenderAccountAdminSafe());
        return true;
      }
      if(path==='/admin/quan-tri'||path==='/admin/quan-tri/danh-muc'||path==='/admin/quan-tri/kiem-tra'||path==='/admin/quan-tri/cau-hinh'){
        if(!requireRoles(['admin']))return false;
        if(path==='/admin/quan-tri/danh-muc'&&typeof window.phfRenderAdminPlaceholder==='function') await Promise.resolve(window.phfRenderAdminPlaceholder('Danh mục chung'));
      ...
      if(runId===routeRenderSequence && window.PHFAppShell){
        try{window.PHFAppShell.syncFromRoute(finalPath,{clear:!/^\/(?:admin|ql|hv)(?:$|\/(?:hub|classroom|checklist|knl|ai-sandbox)(?:\/|$))/.test(finalPath)});}catch(e){}
      }
  ...
  function installWrappers(){
    ...
    commandWrap('phfRenderAccountAdminSafe',function(){return '/admin/nhan-su/tai-khoan';});
