  ...
  main.innerHTML=`<section class="phf-hr-home" aria-label="Trang chủ PHF HR">
    ...
    <main class="phf-hr-main">
      ...
      <section class="phf-hr-modules" aria-label="Các hệ thống PHF HR">
        ...
        <article class="is-knl"><div class="phf-hr-card-head"><span>${icon('knl')}</span><div><h2>Khung năng lực</h2><b>Đánh giá &amp; Phát triển</b></div></div><p>Đánh giá năng lực, xem kết quả và xây dựng kế hoạch phát triển.</p><div class="phf-hr-card-status">Nhân sự &amp; phân quyền KNL</div><button type="button" data-phf-hr-module="knl">Truy cập <span>→</span></button></article>
      </section>
