...
// PHF HR — CHƯƠNG TRÌNH THI ĐUA (Competition) V1 (live on Production since
// V1.3). One route POST /v1/competition dispatches a Competition action
// against Company PostgreSQL competition.*. The verified `actor` is supplied
// by the Vercel identity layer across the service-token boundary — this
// service never resolves identity itself. No Task behaviour is touched.
