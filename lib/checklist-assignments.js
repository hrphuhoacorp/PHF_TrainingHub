...
function publicRow(r){
  return {
    ...
    employeeStatus:r.employee_status||'Đang làm việc', templateId:r.template_id||'', templateVersion:r.template_version||'', effectiveDate:r.effective_date||'', reason:r.reason||'', updatedAt:r.updated_at||''
  };
}
function comparable(r){ return JSON.stringify([r.employee_id,r.employee_code,r.employee_name,r.department,r.title,r.branch,r.manager_id,r.manager_code,r.manager_name,r.employee_status,r.template_id,r.template_version,r.effective_date]); }
