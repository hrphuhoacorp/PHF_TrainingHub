...
async function saveData(payload) {
  ...
  console.log('PHF SAVE EMPLOYEE:', employee);

const employeeSave = await supabase.from('employees').upsert({
  id: employeeId,
...
if (employeeSave.error) {
  console.error('SUPABASE EMPLOYEE SAVE ERROR:', employeeSave.error);
  throw employeeSave.error;
}
