...
async function readDataFromSupabase() {
  ...
  return { settings, employees: employeesMapped, progress, testResults: testResultsMapped, activityLog: activityLogMapped, evaluationRecords: evaluationRecordsMapped };
}
