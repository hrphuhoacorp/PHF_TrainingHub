...
const CAPABILITY_KEYS = ['access_knl', 'view_people', 'propose', 'agree_proposal', 'approve', 'manage_framework', 'manage_permissions', 'income_view', 'view_proposals'];
...
const PRESETS = Object.freeze({
  NHAN_VIEN: {
    name: 'Nhân viên',
    capabilities: { access_knl: true, view_people: true, propose: false, agree_proposal: false, approve: false, manage_framework: false, manage_permissions: false, income_view: false, view_proposals: false },
  ...
  CUSTOM: {
    name: 'Tùy chỉnh',
    capabilities: { access_knl: false, view_people: false, propose: false, agree_proposal: false, approve: false, manage_framework: false, manage_permissions: false, income_view: false, view_proposals: false },
    peopleScope: { type: 'self', values: [], reservedEmployees: [] }
  }
});
...
async function resolveActorGrant(session) {
  ...
  if (a.role === 'admin') {
    return {
      ...
      capabilities: capabilities({ access_knl: true, view_people: true, propose: true, agree_proposal: true, approve: true, manage_framework: true, manage_permissions: true, income_view: true, view_proposals: true }),
      peopleScope: { type: 'all_company', values: [], reservedEmployees: [] },
      row: null,
      identity: a
    };
